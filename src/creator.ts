...
// 真实姓名库（符合年轻人）
const REAL_NAMES = {
  female: ['王诗涵', '李欣怡', '张雨萱', '刘思琪', '陈可欣', '杨晓晴', '赵雨桐', '黄思颖', '周子涵', '吴雨薇', '徐佳怡', '孙雅琪', '马梦瑶', '朱语嫣', '胡雨欣', '郭欣然', '何诗琪', '林雨萱', '高雅婷', '罗思涵'],
  male: ['王浩然', '李子轩', '张俊杰', '刘宇航', '陈思远', '杨子墨', '赵明轩', '黄浩宇', '周子豪', '吴俊熙', '徐浩轩', '孙宇辰', '马子轩', '朱浩然', '胡俊杰', '郭子涵', '何宇轩', '林浩宇', '高子豪', '罗俊杰'],
}
